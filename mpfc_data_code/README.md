## Processing the mpfc dataset

Convert the mouse brain dataset:

convert_mpfc_data.Rmd

Generate graph objects for each image (this step can be run parallely):

generate_graph_data_object_dist_380_mpfc_prepare.py

generate_graph_data_object_dist_380_mpfc_prepare.sh
...
copy_graph_files_for_images.ipynb
